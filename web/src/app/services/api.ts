        ...
        if (response.ok) {
          ...
          return {
            metrics: {
              ...
              safetyState: raw.safetyState || "NORMAL",
              alarmReason: raw.alarmReason || "NONE",
              spikeRate: raw.spikeRate || 0,
              graceRemainingSec: raw.graceRemainingSec || 0,
              tempThreshold: raw.tempThreshold || 45,
              currentLimit: raw.currentLimit || 10,
              graceDelaySec: raw.graceDelaySec || 15,
              spikeLimit: raw.spikeLimit || 4.0,
            },
            statusState: {
